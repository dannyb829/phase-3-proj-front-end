...
function About() {
  ...
  return ( <div id='about-page' style={{backgroundColor:'#2F2F2F', height:'100vh', textAlign:'center'}}>
      ...
      <CardContent sx={{textAlign:'center'}}>
        ...
        Here at Dog 101 we value, the loving relationships between loving owners and their beautiful dogs! 
